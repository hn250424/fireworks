const POINT = {
    RED: [
        ...
        { x: 5.00, y: 10, z: 0.00 }, // 0°
        { x: 4.33, y: 10, z: 2.50 }, // 30°
        { x: 2.50, y: 10, z: 4.33 }, // 60°
        { x: 0.00, y: 10, z: 5.00 }, // 90°
        { x: -2.50, y: 10, z: 4.33 }, // 120°
        { x: -4.33, y: 10, z: 2.50 }, // 150°
        { x: -5.00, y: 10, z: 0.00 }, // 180°
        { x: -4.33, y: 10, z: -2.50 }, // 210°
        { x: -2.50, y: 10, z: -4.33 }, // 240°
        { x: 0.00, y: 10, z: -5.00 }, // 270°
        { x: 2.50, y: 10, z: -4.33 }, // 300°
        { x: 4.33, y: 10, z: -2.50 }, // 330°

        { x: 0.00, y: 15.00, z: 0.00 }, // 0°
        { x: 0.00, y: 12.50, z: 4.33 }, // 60°
        { x: 0.00, y: 7.50, z: 4.33 }, // 120°
        { x: 0.00, y: 5.00, z: 0.00 }, // 180°
        { x: 0.00, y: 10.00, z: -5.00 }, // 270°
        { x: 0.00, y: 12.50, z: -4.33 }, // 300°
        { x: 0.00, y: 14.33, z: -2.50 }, // 330°

        { x: 5.00, y: 10.00, z: 0.00 }, // 0°
        { x: 4.33, y: 12.50, z: 0.00 }, // 30°
        { x: 2.50, y: 14.33, z: 0.00 }, // 60°
        { x: 0.00, y: 15.00, z: 0.00 }, // 90°
        { x: -2.50, y: 14.33, z: 0.00 }, // 120°
        { x: -4.33, y: 12.50, z: 0.00 }, // 150°
        { x: -5.00, y: 10.00, z: 0.00 }, // 180°
        { x: -4.33, y: 7.50, z: 0.00 }, // 210°
        { x: -2.50, y: 5.67, z: 0.00 }, // 240°
        { x: 0.00, y: 5.00, z: 0.00 }, // 270°
        { x: 2.50, y: 5.67, z: 0.00 }, // 300°
        { x: 4.33, y: 7.50, z: 0.00 }, // 330°
