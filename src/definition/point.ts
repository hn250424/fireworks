const POINT = {
    ...
    EXPLOSION_OFFSET: {
        PETITE_BURST: [
            ...
            // 90
            { x: 0.00, y: 14.67, z: 1.25 },
            { x: 0.00, y: 14.67, z: -1.25 },
            { x: 1.25, y: 14.67, z: 0.00 },
            { x: -1.25, y: 14.67, z: 0.00 },

            { x: 0.00, y: 10.33, z: 1.25 },
            { x: 0.00, y: 10.33, z: -1.25 },
            { x: 1.25, y: 10.33, z: 0.00 },
            { x: -1.25, y: 10.33, z: 0.00 },

            // 45
            { x: 0.00, y: 13.75, z: 2.17 },
            { x: 1.55, y: 13.75, z: 1.55 },
            { x: -1.55, y: 13.75, z: 1.55 },
            { x: 2.15, y: 13.75, z: 0.00 },
            { x: -2.15, y: 13.75, z: 0.00 },
            { x: 1.55, y: 13.75, z: -1.55 },
            { x: -1.55, y: 13.75, z: -1.55 },
            { x: 0.00, y: 13.75, z: -2.17 },

            { x: 0.00, y: 11.25, z: 2.17 },
            { x: 1.55, y: 11.25, z: 1.55 },
            { x: -1.55, y: 11.25, z: 1.55 },
            { x: 2.15, y: 11.25, z: 0.00 },
            { x: -2.15, y: 11.25, z: 0.00 },
            { x: 1.55, y: 11.25, z: -1.55 },
            { x: -1.55, y: 11.25, z: -1.55 },
            { x: 0.00, y: 11.25, z: -2.17 },
            ...
            // 30
            { x: 2.50, y: 12.50, z: 0.00 },
            { x: 2.17, y: 12.50, z: 1.25 },
            { x: 1.25, y: 12.50, z: 2.17 },
            { x: 0.00, y: 12.50, z: 2.50 },
            { x: -1.25, y: 12.50, z: 2.17 },
            { x: -2.17, y: 12.50, z: 1.25 },
            { x: -2.50, y: 12.50, z: 0.00 },
            { x: -2.17, y: 12.50, z: -1.25 },
        ...
        BLOOM: [
            ...
            // 90
            { x: 0.00, y: 24.67, z: 1.25 },
            { x: 0.00, y: 24.67, z: -1.25 },
            { x: 1.25, y: 24.67, z: 0.00 },
            { x: -1.25, y: 24.67, z: 0.00 },

            { x: 0.00, y: 20.33, z: 1.25 },
            { x: 0.00, y: 20.33, z: -1.25 },
            { x: 1.25, y: 20.33, z: 0.00 },
            { x: -1.25, y: 20.33, z: 0.00 },

            // 45
            { x: 0.00, y: 23.75, z: 2.17 },
            { x: 1.55, y: 23.75, z: 1.55 },
            { x: -1.55, y: 23.75, z: 1.55 },
            { x: 2.15, y: 23.75, z: 0.00 },
            { x: -2.15, y: 23.75, z: 0.00 },
            { x: 1.55, y: 23.75, z: -1.55 },
            { x: -1.55, y: 23.75, z: -1.55 },
            { x: 0.00, y: 23.75, z: -2.17 },

            { x: 0.00, y: 21.25, z: 2.17 },
            { x: 1.55, y: 21.25, z: 1.55 },
            { x: -1.55, y: 21.25, z: 1.55 },
            { x: 2.15, y: 21.25, z: 0.00 },
            { x: -2.15, y: 21.25, z: 0.00 },
            { x: 1.55, y: 21.25, z: -1.55 },
            { x: -1.55, y: 21.25, z: -1.55 },
            { x: 0.00, y: 21.25, z: -2.17 },
            ...
            // 30
            { x: 2.50, y: 22.50, z: 0.00 },
            { x: 2.17, y: 22.50, z: 1.25 },
            { x: 1.25, y: 22.50, z: 2.17 },
            { x: 0.00, y: 22.50, z: 2.50 },
            { x: -1.25, y: 22.50, z: 2.17 },
            { x: -2.17, y: 22.50, z: 1.25 },
            { x: -2.50, y: 22.50, z: 0.00 },
            { x: -2.17, y: 22.50, z: -1.25 },
        ...
        HUGE_BURST: [
            // Baseline.
            { x: 0.00, y: 20.00, z: -10.00 },   // theta 180, phi 90.  
            { x: 0.00, y: 22.6, z: -9.6 },   // theta 165, phi 90.
            { x: 0.00, y: 25.00, z: -8.66 }, // theta 150, phi 90.
            { x: 0.00, y: 27.00, z: -7.1 }, // theta 135, phi 90.
            { x: 0, y: 28.66, z: -5.00 }, // theta 120, phi 90.
            { x: 0, y: 29.7, z: -2.6 }, // theta 105, phi 90.
            { x: 0.00, y: 30.00, z: 0.00 }, // theta 90, phi 90.
            { x: 0, y: 29.7, z: 2.6 }, // theta 75, phi 90.
            { x: 0, y: 28.66, z: 5.00 }, // theta 60, phi 90.
            { x: 0.00, y: 27.00, z: 7.1 }, // theta 45, phi 90.
            { x: 0.00, y: 25.00, z: 8.66 }, // theta 30, phi 90.
            { x: 0.00, y: 22.6, z: 9.6 },   // theta 15, phi 90.
            { x: 0.00, y: 20.00, z: 10.00 },  // theta 0, phi 90.
            { x: 0.00, y: 17.4, z: 9.6 },   // theta -15, phi 90.
            { x: 0.00, y: 15.00, z: 8.66 }, // theta -30, phi 90.
            { x: 0.00, y: 13.00, z: 7.1 }, // theta -45, phi 90.
            { x: 0, y: 11.34, z: 5.00 }, // theta -60, phi 90.
            { x: 0, y: 10.3, z: 2.6 }, // theta -75, phi 90.
            { x: 0.00, y: 10.00, z: 0.00 }, // theta -90, phi 90.
            { x: 0, y: 10.3, z: -2.6 }, // theta -105, phi 90.
            { x: 0, y: 11.34, z: -5.00 }, // theta -120, phi 90.
            { x: 0.00, y: 13.00, z: -7.1 }, // theta -135, phi 90.
            { x: 0.00, y: 15.00, z: -8.66 }, // theta -150, phi 90.
            { x: 0.00, y: 17.4, z: -9.6 },   // theta -165, phi 90.

            // theta 0, phi 90.
            { x: 10.00, y: 20.00, z: 0.00 },    // 90
            { x: 9.66, y: 20.00, z: 2.6 },      // 75
            { x: 8.66, y: 20.00, z: 5.00 },     // 60
            { x: 7.07, y: 20.00, z: 7.07 },     // 45
            { x: 5.00, y: 20.00, z: 8.66 },     // 30
            { x: 2.59, y: 20.00, z: 9.66 },     // 15
            // { x: 0.00, y: 20.00, z: 10.00 },
            { x: -2.59, y: 20.00, z: 9.66 },    // -15
            { x: -5.00, y: 20.00, z: 8.66 },    // -30
            { x: -7.07, y: 20.00, z: 7.07 },    // -45
            { x: -8.66, y: 20.00, z: 5.00 },    // -60
            { x: -9.66, y: 20.00, z: 2.6 },     // -75
            { x: -10.00, y: 20.00, z: 0.00 },   // -90
            { x: -9.66, y: 20.00, z: -2.6 },
            { x: -8.66, y: 20.00, z: -5.00 },
            { x: -7.07, y: 20.00, z: -7.07 },
            { x: -5.00, y: 20.00, z: -8.66 },
            { x: -2.59, y: 20.00, z: -9.66 },
            // { x: 0.00, y: 20.00, z: -10.00 },
            { x: 2.59, y: 20.00, z: -9.66 },
            { x: 5.00, y: 20.00, z: -8.66 },
            { x: 7.07, y: 20.00, z: -7.07 },
            { x: 8.66, y: 20.00, z: -5.00 },
            { x: 9.66, y: 20.00, z: -2.6 },
            { x: 10.00, y: 20.00, z: 0.00 },

            // theta 15, phi 90.
            { x: 0.00, y: 22.6, z: 9.6 },
            { x: 2.48, y: 22.6, z: 9.27 },    // 15
            { x: 4.8, y: 22.6, z: 8.3 },    // 30
            { x: 6.79, y: 22.6, z: 6.79 },    // 45
            { x: 8.3, y: 22.6, z: 4.8 },    // 60
            { x: 9.27, y: 22.6, z: 2.48 },    // 75
            { x: 9.6, y: 22.6, z: 0 },    // 90
            { x: -2.48, y: 22.6, z: 9.27 },
            { x: -4.8, y: 22.6, z: 8.3 },
            { x: -6.79, y: 22.6, z: 6.79 },
            { x: -8.3, y: 22.6, z: 4.8 },
            { x: -9.27, y: 22.6, z: 2.48 },
            { x: 4.8, y: 22.6, z: -8.3 },
            { x: 8.3, y: 22.6, z: -4.8 },
            { x: -4.8, y: 22.6, z: -8.3 },
            { x: -8.3, y: 22.6, z: -4.8 },
            ...
            // theta -15, phi 90.
            { x: 0.00, y: 17.4, z: 9.6 },
            { x: 2.48, y: 17.4, z: 9.27 },    // 15
            { x: 4.8, y: 17.4, z: 8.3 },    // 30
            { x: 6.79, y: 17.4, z: 6.79 },    // 45
            { x: 8.3, y: 17.4, z: 4.8 },    // 60
            { x: 9.27, y: 17.4, z: 2.48 },    // 75
            { x: 9.6, y: 17.4, z: 0 },    // 90
            { x: -2.48, y: 17.4, z: 9.27 },
            { x: -4.8, y: 17.4, z: 8.3 },
            { x: -6.79, y: 17.4, z: 6.79 },
            { x: -8.3, y: 17.4, z: 4.8 },
            { x: -9.27, y: 17.4, z: 2.48 },
            { x: 4.8, y: 17.4, z: -8.3 },
            { x: 8.3, y: 17.4, z: -4.8 },
            { x: -4.8, y: 17.4, z: -8.3 },
            { x: -8.3, y: 17.4, z: -4.8 },
            ...
            // theta 30, phi 90.
            // { x: 0.00, y: 25.00, z: 8.66 },
            { x: 4.3, y: 25.00, z: 7.44 },      // 30
            { x: 7.44, y: 25.00, z: 4.3 },      // 60
            { x: 8.60, y: 25.00, z: 0 },        // 90
            { x: -8.60, y: 25.00, z: 0 },
            { x: -7.44, y: 25.00, z: 4.3 },
            { x: -4.3, y: 25.00, z: 7.44 },
            { x: -4.3, y: 25.00, z: -7.44 },
            { x: -7.44, y: 25.00, z: -4.3 },
            { x: 7.44, y: 25.00, z: -4.3 },
            { x: 4.3, y: 25.00, z: -7.44 },
            ...
            // theta -30, phi 90.
            // { x: 0.00, y: 15, z: 8.66 },
            { x: 4.3, y: 15, z: 7.44 },      // 30
            { x: 7.44, y: 15, z: 4.3 },      // 60
            { x: 8.60, y: 15, z: 0 },        // 90
            { x: -8.60, y: 15, z: 0 },
            { x: -7.44, y: 15, z: 4.3 },
            { x: -4.3, y: 15, z: 7.44 },
            ...
            // theta 45, phi 90.
            { x: 3.55, y: 27.00, z: 6.14 },     // 30
            { x: 6.14, y: 27.00, z: 3.55 },     // 60
            { x: 7.1, y: 27.00, z: 0 },         // 90
            { x: -7.1, y: 27.00, z: 0 },
            { x: -3.55, y: 27.00, z: 6.14 },
            { x: -6.14, y: 27.00, z: 3.55 },
            { x: 3.55, y: 27.00, z: -6.14 },
            { x: 6.14, y: 27.00, z: -3.55 },
            { x: -3.55, y: 27.00, z: -6.14 },
            { x: -6.14, y: 27.00, z: -3.55 },
            ...
            // theta -45, phi 90.
            { x: 3.55, y: 13, z: 6.14 },     // 30
            { x: 6.14, y: 13, z: 3.55 },     // 60
            { x: 7.1, y: 13, z: 0 },         // 90
            { x: -7.1, y: 13, z: 0 },
            { x: -3.55, y: 13, z: 6.14 },
            { x: -6.14, y: 13, z: 3.55 },
            ...
            // theta 60, phi 90.
            // { x: 0, y: 28.66, z: 5.00 },
            // { x: 0.00, y: 28.66, z: -5.00 },
            { x: 5.00, y: 28.66, z: 0 },
            { x: 3.53, y: 28.66, z: 3.53 },
            { x: 3.53, y: 28.66, z: -3.53 },
            { x: -3.53, y: 28.66, z: 3.53 },
            { x: -3.53, y: 28.66, z: -3.53 },
            { x: -5.00, y: 28.66, z: 0 },
            ...
            // theta -60, phi 90.
            // { x: 0, y: 11.34, z: 5.00 },
            // { x: 0.00, y: 11.34, z: -5.00 },
            { x: 5.00, y: 11.34, z: 0 },
            { x: 3.53, y: 11.34, z: 3.53 },
            { x: 3.53, y: 11.34, z: -3.53 },
            { x: -3.53, y: 11.34, z: 3.53 },
            { x: -3.53, y: 11.34, z: -3.53 },
            { x: -5.00, y: 11.34, z: 0 },
            ...
            // theta 75, phi 90.
            // { x: 0, y: 29.7, z: 2.6 },   // 0.
            { x: 1.83, y: 29.7, z: 1.83 },      // 45
            { x: -1.83, y: 29.7, z: 1.83 },
            { x: 1.83, y: 29.7, z: -1.83 },
            { x: -1.83, y: 29.7, z: -1.83 },
            { x: 2.6, y: 29.7, z: 0 },      // 90
            { x: -2.6, y: 29.7, z: 0 },
            ...
            // theta -75, phi 90.
            // { x: 0, y: 10.3, z: 2.6 },   // 0.
            { x: 1.83, y: 10.3, z: 1.83 },      // 45
            { x: -1.83, y: 10.3, z: 1.83 },
            { x: 1.83, y: 10.3, z: -1.83 },
            { x: -1.83, y: 10.3, z: -1.83 },
            { x: 2.6, y: 10.3, z: 0 },      // 90
            { x: -2.6, y: 10.3, z: 0 },
