const POINT = {
    ...
    EXPLOSION_OFFSET: {
        ...
        ERUPT: [
            ...
            { x: 2.00, y: 16, z: 0.00 }, // 0°
            { x: -1.00, y: 16, z: 1.73 }, // 120°
            { x: -1.00, y: 16, z: -1.73 }, // 240°
        ],
        BLOOM: [
            { x: 7, y: 14, z: 4 },
            { x: 7, y: 13.5, z: 3.5 },
        ...
        CHAIN_BURST: {
            ...
            EXPLOSION: [
                { x: 2.17, y: 6, z: 1.25 },   // 30°
                { x: 1.25, y: 6, z: 2.17 },   // 60°
                { x: -1.25, y: 6, z: 2.17 },   // 120°
                { x: -2.17, y: 6, z: 1.25 },   // 150°
                { x: -2.17, y: 6, z: -1.25 },  // 210°
                { x: -1.25, y: 6, z: -2.17 },  // 240°
                { x: 1.25, y: 6, z: -2.17 },  // 300°
                { x: 2.17, y: 6, z: -1.25 },    // 330°
        
                { x: 1.25, y: 5, z: 0 },   // 0°
                { x: 0.75, y: 5, z: 0.75 }, // 45°
                { x: 0, y: 5, z: 1.25 },   // 90°
                { x: -0.75, y: 5, z: 0.75 }, // 135°
                { x: -1.25, y: 5, z: 0 },  // 180°
                { x: -0.75, y: 5, z: -0.75 }, // 225°
                { x: 0, y: 5, z: -1.25 },   // 270°
                { x: 0.75, y: 5, z: -0.75 }  // 315°
            ],
        },
    }
}
